...
{
	if(clamp)
		Extensions::instance()->glCombinerParameteriNV(GL_COLOR_SUM_CLAMP_NV, GL_TRUE);
	else
		Extensions::instance()->glCombinerParameteriNV(GL_COLOR_SUM_CLAMP_NV, GL_FALSE);

	Extensions::instance()->glFinalCombinerInputNV(
		GL_VARIABLE_A_NV,
		rgb.a.reg.bits.name,
		rgb.a.map,
